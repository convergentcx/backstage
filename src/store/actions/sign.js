...
const handleSignup = async (publicAddress) => {
	...
	const response = await fetch('http://ec2-18-215-237-55.compute-1.amazonaws.com:3002/users/' + publicAddress, {
		method: 'POST',
	})
...
const handleAuthenticate = async ({ publicAddress, signature, address }) => {
	const response = await fetch(`http://ec2-18-215-237-55.compute-1.amazonaws.com:3002/auth`, {
